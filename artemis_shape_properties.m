function [m, S_eff, CL, CD, alpha] = artemis_shape_properties(V, h)
...
h_drogue = 6789.112152; % Drogue parachute deployment.
h_main = 1936.235904; % Main parachute deployment. 
h_land = 0; % Landing.

% Vehicle mass at each phase (kg).
m_EI = 10310.0839260; 
m_drogue = 9921.2639011; 
m_main = 9852.6486027;
m_final = 9298.6436000;
...
B = 2.5146; % Cone base radius (m).

R = 5.735; % Sphere radius (m).
